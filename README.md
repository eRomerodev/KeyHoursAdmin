...
1. Extraer el archivo ZIP en tu escritorio
2. La carpeta debe llamarse "Key hours"

**Opción B - Si tienes acceso al repositorio Git:**
```bash
...
### 🐍 **PASO 3: CONFIGURAR BACKEND (DJANGO) - ORDEN EXACTO**
...
### ⚛️ **PASO 4: CONFIGURAR FRONTEND (REACT) - ORDEN EXACTO**
